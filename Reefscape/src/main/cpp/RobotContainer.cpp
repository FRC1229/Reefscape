...
void RobotContainer::ConfigureButtonBindings() {
  ...
  frc2::JoystickButton(&m_driverController, 9).OnTrue(frc2::cmd::RunOnce([this]{m_Led.sideLed("right");}));
  frc2::JoystickButton(&m_driverController, 10).OnTrue(frc2::cmd::RunOnce([this]{m_Led.sideLed("left");}));
